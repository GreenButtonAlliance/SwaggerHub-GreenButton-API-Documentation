    ...
    public class Startup
    {
            ...
            services
                .AddSwaggerGen(c =>
                {
                    c.SwaggerDoc("1.0.0", new OpenApiInfo
                    {
                        ...
                        Description = "Green Button Resource Server ApplicationInformation API Documentation (ASP.NET Core 3.1)",
                        Contact = new OpenApiContact()
                        {
                           Name = "Donald F. Coffin",
                           Url = new Uri("https://greenbuttonalliance.org"),
                    ...
                    c.DocumentFilter<BasePathFilter>("/GreenButtonAlliance/Green_Button_Resource_Server");
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                ...
                c.SwaggerEndpoint("/swagger/1.0.0/swagger.json", "Green Button Resource Server ApplicationInformation API Documentation");

                //TODO: Or alternatively use the original Swagger contract that's included in the static files
                // c.SwaggerEndpoint("/swagger-original.json", "Green Button Resource Server ApplicationInformation API Documentation Original");
            });
